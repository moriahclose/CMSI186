 ...
 *  @version 2.1.0  2018-01-27  M.T. Tolliver Added a few more tests 
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
public class StringStuffTester {
   ...
   */
   public static void test_containsVowel() {
      ...
      try { System.out.println( StringStuff.containsVowel( "The quick brown fox." ) ? "PASS" : StringStuff.containsVowel( "The quick brown fox." ) ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Test for all uppercase vowels: " );
      try { System.out.println( StringStuff.containsVowel( "JUMPED OVER THE LAZY DOG." ) ? "PASS" : StringStuff.containsVowel( "JUMPED OVER THE LAZY DOG." ) ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Test for detecting lowercase 'a': " );
      try { System.out.println( StringStuff.containsVowel( "a" ) ? "PASS" : StringStuff.containsVowel( "a" ) ); }
      catch( Exception e ) { System.out.println ( false ); }
      ...
      try { System.out.println( StringStuff.containsVowel( "e" ) ? "PASS" : StringStuff.containsVowel( "e" ) ); }
      catch( Exception e ) { System.out.println ( false ); }
      ...
      try { System.out.println( StringStuff.containsVowel( "i" ) ? "PASS" : StringStuff.containsVowel( "i" ) ); }
      catch( Exception e ) { System.out.println ( false ); }
      ...
      try { System.out.println( StringStuff.containsVowel( "o" ) ? "PASS" : StringStuff.containsVowel( "o" ) ); }
      catch( Exception e ) { System.out.println ( false ); }
      ...
      try { System.out.println( StringStuff.containsVowel( "u" ) ? "PASS" : StringStuff.containsVowel( "u" ) ); }
      catch( Exception e ) { System.out.println ( false ); }
      ...
      try { System.out.println( StringStuff.containsVowel( "y" ) ? "PASS" : StringStuff.containsVowel( "y" ) ); }
      catch( Exception e ) { System.out.println ( false ); }
      ...
      try { System.out.println( StringStuff.containsVowel( "bdBDBDbd" ) ? StringStuff.containsVowel( "bdBDBDbd" ) : "PASS"); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Test for string containing numbers and symbols with 'a' at the end: " );
      try { System.out.println( StringStuff.containsVowel( "1234567890!@#$%^&*()a" ) ? "PASS" : StringStuff.containsVowel( "1234567890!@#$%^&*()a" ) ); }
      catch( Exception e ) { System.out.println ( false ); }
   ...
   */
   public static void test_isPalindrome() {
      ...
      try { System.out.println( StringStuff.isPalindrome( "a" ) ? "PASS" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'ab' should return false: " );
      try { System.out.println( StringStuff.isPalindrome( "ab" ) ? "true" : "PASS" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'aba' should return true: " );
      try { System.out.println( StringStuff.isPalindrome( "aba" ) ? "PASS" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'amanaplanacanalpanama' should return true: " );
      try { System.out.println( StringStuff.isPalindrome( "amanaplanacanalpanama" ) ? "PASS" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'ABBA' should return true: " );
      try { System.out.println( StringStuff.isPalindrome( "ABBA" ) ? "PASS" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'RaCeCaR' should return true: " );
      try { System.out.println( StringStuff.isPalindrome( "RaCeCaR" ) ? "PASS" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'madamiamadam' should return false: " );
      try { System.out.println( StringStuff.isPalindrome( "madamiamadam" ) ? "true" : "PASS" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'abcdefghigfedcba' should return false: " );
      try { System.out.println( StringStuff.isPalindrome( "abcdefghigfedcba" ) ? "true" : "PASS" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'abcdefgh gfedcba' should return false: " );
      try { System.out.println( StringStuff.isPalindrome( "abcdefgh gfedcba" ) ? "true" : "PASS" ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing '1!2@3#4$5%5$4#3@2!1' should return true: " );
      try { System.out.println( StringStuff.isPalindrome( "1!2@3#4$5%5$4#3@2!1" ) ? "PASS" : "false" ); }
      catch( Exception e ) { System.out.println ( false ); }
   ...
   */
   public static void test_oddsOnly() {
      ...
      System.out.print( "   Testing 'Cxylophones' should return yooes: " );
      try { System.out.println( (0 == StringStuff.oddsOnly( "Cxylophones" ).compareTo( "Cyooes" )) ? "got it" : "don't got it" ); }
      catch( Exception e ) { System.out.println ( false ); }
   ...
   */
   public static void test_reverse() {
      ...
      System.out.print( "   Testing '123$%%^' should return '^%%$321': " );
      try { System.out.println( (0 == StringStuff.reverse( "123$%%^" ).compareTo("^%%$321")) ? "got it" : "don't got it" ); }
      catch( Exception e ) { System.out.println ( false ); }
   }
   ...
   */
   public static void test_removeDupes() {
      ...
      try { System.out.println( (0 == StringStuff.removeDupes( "xylophones" ).compareTo( "xylophnes" )) ? "got it" : StringStuff.removeDupes( "xylophones" ) ); }
      catch( Exception e ) { System.out.println ( false ); }
      ...
      try { System.out.println( (0 == StringStuff.removeDupes( "AmanAplanAcAnalpAnamA" ).compareTo("Amanplc")) ? "got it" : StringStuff.removeDupes( "AmanAplanAcAnalpAnamA" ) ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'shutTheFrontDoor11233455677890' should return shutTeFronD1234567890: " );
      try { System.out.println( (0 == StringStuff.removeDupes( "shutTheFrontDoor11234567890" ).compareTo("shutTeFronD1234567890")) ? "got it" : StringStuff.removeDupes( "shutTheFrontDoor11234567890" ) ); }
      catch( Exception e ) { System.out.println ( false ); }

      System.out.print( "   Testing 'ABaBAAbABCY' should return ABabCY: " );
      try { System.out.println( (0 == StringStuff.removeDupes( "ABaBAAbABCY" ).compareTo("ABabCY")) ? "got it" : StringStuff.removeDupes( "ABaBAAbABCY" ) ); }
      catch( Exception e ) { System.out.println ( false ); }
