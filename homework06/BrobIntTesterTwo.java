/** ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * File name  :  BrobIntTesterTwo.java
...
public class BrobIntTesterTwo {
   ...
   public static void main( String[] args ) {
      ...
      try {
         System.out.println( "      expecting: " + new BrobInt( "0" ) + "\n" +
                             "        and got: " + g5.toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
      ...
      try {
         System.out.println( "      expecting: " + new BrobInt( "1" ) + "\n" +
                             "        and got: " + g6.toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
      ...
      try {
         System.out.println( "      expecting: " + new BrobInt( "10" ) + "\n" +
                             "        and got: " + g7.toString() );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
